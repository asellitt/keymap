const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [0] = LAYOUT_ergodox(
    //---------------.---------------.---------------.---------------.---------------.---------------.--------------.
    // `             | 1             | 2             | 3             | 4             | 5             | {            |
       TD(THREGRV)   , TD(F1_1)      , TD(F2_2)      , TD(F3_3)      , TD(F4_4)      , TD(F5_5)      , KC_LCBR      ,
    // H: ```        |         D: F1 |         D: F2 |         D: F3 |         D: F4 |         D: F5 |              |
    //---------------.---------------.---------------.---------------.---------------.---------------.--------------.
    // TAB           | Q             | W             | E             | R             | T             | [            |
    ...
    //--------------.---------------.---------------.---------------.---------------.---------------.---------------.
    // -            | 6             | 7             | 8             | 9             | 0             | =             |
       KC_MINS      , TD(F6_6)      , TD(F7_7)      , TD(F8_8)      , TD(F9_9)      , TD(F10_0)     , TD(THREEQL)   ,
    //              |         D: F6 |         D: F7 |         D: F8 |         D: F9 |        D: F10 | H:===   2:!== |
    //--------------.---------------.---------------.---------------.---------------.---------------.---------------.
    // ]            | Y             | U             | I             | O             | P             | '             |
