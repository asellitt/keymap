const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [0] = LAYOUT_ergodox_pretty(
    TD(THREGRV),KC_1,    KC_2,     KC_3,     KC_4,     KC_5,    KC_LCBR,      /**/KC_MINS,       KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    TD(THREEQL),
    ...
    KC_LSFT,    KC_Z,    TD(XCUT), TD(CCPY), TD(VPST), KC_B,    M_ROCKET,     /**/KC_COLN,       KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,
